...
reconfiguration loop (Section~\ref{sec:multi:topology}) reads the current neighbourhood graph, computes the connected components, and rewrites and redeploys the affected
